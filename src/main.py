...
if __name__ == "__main__":
    try:
        ...
        # Any validation failure anywhere in the pipeline (bad telemetry,
        # a malformed historical events file, a broken integration between
        # stages) is caught here and reported with a clear, specific
        # message instead of crashing with a raw traceback.
        print(f"\nPipeline stopped: {e}")
        print("Check the input data and try again.")
